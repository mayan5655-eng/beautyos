...
// DEFAULT_DAYS is 90 in production terms; temporarily 7 (and MIN_DAYS 1) so
// the lapsed window can be seen populated on a young dataset. Restore to
// DEFAULT_DAYS = 90, MIN_DAYS = 30 once verified.
