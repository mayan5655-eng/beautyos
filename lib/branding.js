...
export function resolveBranding(row) {
  ...
  return {
    ...
    serviceImages: b.service_images && typeof b.service_images === "object" && !Array.isArray(b.service_images)
      ...
      : {},
    // Client photos are NOT here: they carry a consent record, which must never sit
    // in a jsonb this function returns whole. See lib/results.js and treatment_results.
