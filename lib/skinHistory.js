...
// Dependency-free ESM so it can be imported by any server route and exercised by
// an offline dry-run harness.
 ...
 */
export function analyzeClientSkinHistory(scans, opts = {}) {
 ...
 */
export function summarizeTenantSkinTrends(scans, opts = {}) {
