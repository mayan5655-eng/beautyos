...
//
// CommonJS on purpose: lets a plain `node` harness require() it directly while
// Next.js still imports it normally.
 ...
 */
function listAvailableSlots({ dayHours, appointments, dateStr, durationMin, nowHour }) {
...
module.exports = { listAvailableSlots, busyIntervals, overlapsBusy, pad2 };
